...
or
docker/docker-build.bat auditforge v0.1.0
```
...
or
docker/docker-build.sh auditforge v0.1.0
```

### Manual Build
```bash
# Build with default tags
docker build -t auditforge:latest docker/

# Build with version tag
docker build -t auditforge:v0.1.0 docker/

# Build with custom registry
docker build -t ghcr.io/your-org/auditforge:latest docker/
```
...
docker-compose -f docker/docker-compose.app.yml logs app
```
...
docker build --no-cache -t auditforge:latest docker/
```
...
```bash
# Start services (background) - Lightweight mode
docker-compose -f docker/docker-compose.app.yml up -d
...
docker-compose -f docker/docker-compose.app.yml down -v
```
...
- Docker Folder: [docker/README.md](README.md)
